...
describe('DashboardService', () => {
  ...
  describe('getStats', () => {
    it('should return dashboard statistics', async () => {
      prismaService.enrollment.count = jest.fn()
        .mockResolvedValueOnce(100)
        .mockResolvedValueOnce(25);
      prismaService.enrollment.groupBy = jest.fn()
        .mockResolvedValueOnce([{ studentId: '1' }, { studentId: '2' }])
        .mockResolvedValueOnce([{ studentId: '1' }])
        .mockResolvedValueOnce([{ courseId: '1' }, { courseId: '2' }, { courseId: '3' }]);
  ...
  describe('getDashboardData', () => {
    it('should return chart data', async () => {
      prismaService.enrollment.findMany = jest.fn()
